...
Este documento registra las decisiones arquitectónicas clave tomadas durante el diseño e implementación de la infraestructura base y los módulos `vendors` y `phone-numbers`.
